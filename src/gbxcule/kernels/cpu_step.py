...
from gbxcule.kernels.cpu_step_builder import OpcodeTemplate, build_cpu_step_kernel
...
def get_cpu_step_kernel():  # type: ignore[no-untyped-def]
    ...
    if _cpu_step_kernel is None:
        ...
        from gbxcule.kernels.cpu_templates import alu, jumps, loads, misc
        ...
        _cpu_step_kernel = build_cpu_step_kernel(
            opcode_templates, default_template, constants
        )
