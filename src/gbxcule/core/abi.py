...
PIX_BPP: Final[int] = 2
PACK_PIXELS_PER_BYTE: Final[int] = 4
DOWNSAMPLE_W_BYTES: Final[int] = DOWNSAMPLE_W // PACK_PIXELS_PER_BYTE
PACKED_FRAME_BYTES: Final[int] = DOWNSAMPLE_H * DOWNSAMPLE_W_BYTES
