...
CART_STATE_RTC_LATCHED_SECONDS = 15
CART_STATE_RTC_LATCHED_MINUTES = 16
CART_STATE_RTC_LATCHED_HOURS = 17
CART_STATE_RTC_LATCHED_DAYS_LOW = 18
CART_STATE_RTC_LATCHED_DAYS_HIGH = 19
